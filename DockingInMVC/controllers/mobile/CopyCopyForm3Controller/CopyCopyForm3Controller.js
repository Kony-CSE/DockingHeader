define({
    ...
    FlexCont1CB: function FlexCont1CB(wdg, x, y, contx, conty) {
        ...
        //        };
        if (contentOffset.y > 0 && contentOffset.y < this.FlexCont3CBHeight) {
            this.view.FlexCont3.top = this.FlexCont3CBYpos - contentOffset.y;
            this.view.FlexCont4.top = this.FlexCont4CBYpos - contentOffset.y;
        }
        if (contentOffset.y > this.halfHeightOfCont3 && contentOffset.y < this.FlexCont3CBHeight) {
            this.view.FlexCont2.top = this.FlexCont2CBYpos - contentOffset.y + this.FlexCont3CBHeight;
        }
        if (contentOffset.y > 0 && contentOffset.y < this.FlexCont3CBHeight) {
            this.view.FlexCont1.top = contentOffset.y;
            if (contentOffset.y < this.halfHeightOfCont3) 
              this.view.FlexCont2.top = contentOffset.y + this.FlexCont2CBYpos;
        }
    },
